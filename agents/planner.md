...
- Produce dependency graphs or any structural diagrams in ASCII art — use Mermaid syntax; see [`skills/mermaid-diagrams/SKILL.md`](../skills/mermaid-diagrams/SKILL.md)
