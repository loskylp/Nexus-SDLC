...
| [DEC-0018](DEC-0018-spike-task-ownership.md) | Spike Task Ownership and Lifecycle | **Accepted** | Architect identifies the unknown and writes the acceptance criterion. Planner schedules before dependent tasks. Builder runs the investigation. Architect interprets the finding and produces an ADR if needed. Planner re-estimates affected tasks. |
